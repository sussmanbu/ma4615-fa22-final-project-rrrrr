...
We did modelling based on our created combined dataset **Accident_Traffic** and original dataset **MA_select** to find numerical evidence in supporting our final conclusion. The code for combined dataset can be found at the bottom of the data page.
